        ...
        <div>
            ...
            <div class="row row-cols-1 row-cols-md-3 justify-content-around  gap-3">
                <div class="form-group  row row-cols-1 gap-3 text-right rounded  text-white  p-2 position-relative mt-4 bg-primary">
                    ...
                    <input type="date" class="form-control" name="date_of_preTest" id="date_of_preTest" required placeholder="التاريخ">
                    <input type="time" class="form-control" name="time_of_preTest" id="time_of_preTest" required placeholder="الوقت">
                </div>
                <div class="form-group row row-cols-1 gap-3 rounded text-white text-right p-2 position-relative mt-4 bg-primary">
                    ...
                    <input type="date" class="form-control" name="date_of_postTest" id="date_of_postTest" required placeholder="التاريخ">
                    <input type="time" class="form-control" name="time_of_postTest" id="time_of_postTest" required placeholder="الوقت">
                </div>
            </div>
        </div>
            ...
            <ul class="options-list list-unstyled">
              <li>
                ...
                <label for="q1-firstOption">
                    <input type="text" name="q1-Option" class="form-control optionInput" placeholder="OPTION" required>
                </label>
          ...
          <ul class="options-list list-unstyled">
            <li>
              ...
              <label for="q2-firstOption">
                  <input type="text" name="q2-Option" class="form-control optionInput" placeholder="OPTION" required>
              </label>
              <i class="fa-solid fa-xmark"></i>
            </li>
            <li>
      ...
      <div class="question p-3 bg-primary mb-4" dir="ltr">
        ...
        <ul class="options-list list-unstyled">
          <li>
            ...
            <label for="q1-firstOption">
                <input type="text" name="q3-Option" class="form-control optionInput" placeholder="OPTION" required>
            </label>
            <i class="fa-solid fa-xmark"></i>
          </li>
          <li>
    ...
    <div class="question p-3 bg-primary mb-4" dir="ltr">
      ...
      <ul class="options-list list-unstyled">
        <li>
          ...
          <label for="q1-firstOption">
              <input type="text" name="q4-Option" class="form-control optionInput" placeholder="OPTION" required>
          </label>
          <i class="fa-solid fa-xmark"></i>
        </li>
        <li>
